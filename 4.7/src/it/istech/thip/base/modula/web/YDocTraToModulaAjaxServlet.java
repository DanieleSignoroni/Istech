...
public class YDocTraToModulaAjaxServlet extends BaseServlet{
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YDocTraToModula gestoreEv = (YDocTraToModula)YDocTraToModula.elementWithKey(YDocTraToModula.class, chiaveRiga, 0);
