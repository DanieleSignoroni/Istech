...
public class YDocProToModulaAjaxServlet extends BaseServlet{
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YDocProToModula gestoreEv = (YDocProToModula)YDocProToModula.elementWithKey(YDocProToModula.class, chiaveRiga, 0);
