...
public class YMatProToModulaEditFormModifier  extends WebFormModifierExtended{
	...
	public void writePostHeadElements(JspWriter out) throws IOException {
		...
		out.println(WebJSTypeList.getImportForJSLibrary("it/istech/thip/base/modula/YMatProToModulaEdit.js", getServletEnvironment().getRequest()));
