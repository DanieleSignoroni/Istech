...
public class YDocTraToModulaGridActionAdapter extends GridActionAdapter{
	...
	protected void otherActions(ClassADCollection cadc, ServletEnvironment se) throws ServletException, IOException {
		...
		if("INVIA_MODULA".equals(azione)) {
			try {
				...
				ErrorMessage em = YDocTraToModula.inviaAModulaMultple(objectKeys);
				if(em == null) {
					...
					String url = "/" + se.getServletPath() + "/it.thera.thip.magazzino.documenti.web.DocMagTrasfGridActionAdapter?thClassName=DocMagTrasferimento&ObjectKey="+URLEncoder.encode(key,"UTF-8")+"&thTarget=NEW&thAction=UPDATE_RIGHE";
	...
	public String getWebFormModifierExtended() {
		return "it.istech.thip.base.modula.web.YDocTraToModulaEditFormModifier";
	}

	@Override
	public String getWebGridStylistName() {
		return "it.istech.thip.base.modula.web.YDocTraToModulaStylist";
	}
