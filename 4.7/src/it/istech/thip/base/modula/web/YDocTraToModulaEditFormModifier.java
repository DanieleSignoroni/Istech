...
public class YDocTraToModulaEditFormModifier extends WebFormModifierExtended{
	...
	public void writePostHeadElements(JspWriter out) throws IOException {
		...
		out.println(WebJSTypeList.getImportForJSLibrary("it/istech/thip/base/modula/YDocTraToModulaEdit.js", getServletEnvironment().getRequest()));
