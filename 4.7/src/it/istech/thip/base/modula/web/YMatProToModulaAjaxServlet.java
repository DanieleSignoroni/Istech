...
public class YMatProToModulaAjaxServlet extends BaseServlet{
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YMatProToModula gestoreEv = (YMatProToModula)YMatProToModula.elementWithKey(YMatProToModula.class, chiaveRiga, 0);
