...
public class YDocAcqToModulaGridActionAdapter extends GridActionAdapter{

	private static final long serialVersionUID = 1L;

	public static final String INVIA_LISTA_A_MODULA = "INVIA_MODULA";

	public void modifyToolBar(WebToolBar toolBar) {
		super.modifyToolBar(toolBar);
		WebToolBarButton btn1 = new WebToolBarButton(
				INVIA_LISTA_A_MODULA, "action_submit", "infoArea", "no", "it.sicons.thip.vendite.ordineVE.resources.SiOrdVenRig",
				"Genera", "it/sicons/thip/modula/images/Modula.ico", INVIA_LISTA_A_MODULA, "multipleSelSingleWindow", false);
	...
	protected void otherActions(ClassADCollection cadc, ServletEnvironment se) throws ServletException, IOException {
		...
		if(INVIA_LISTA_A_MODULA.equals(azione)) {
			try {
				String[] objectKeys = se.getRequest().getParameterValues(OBJECT_KEY);
				ErrorMessage em = YDocAcqToModula.inviaAModulaMultple(objectKeys);
				if(em == null) {
					...
					String url = "/" + se.getServletPath() + "/it.thera.thip.acquisti.documentoAC.web.DocumentoAcquistoGridActionAdapter?thClassName=DocumentoAcquisto&ObjectKey="+URLEncoder.encode(key)+"&thTarget=NEW&thAction=UPDATE_RIGHE";
	...
	public String getWebFormModifierExtended() {
		return "it.istech.thip.base.modula.web.YDocAcqToModulaEditFormModifier";
	}

	@Override
	public String getWebGridStylistName() {
		return "it.istech.thip.base.modula.web.YDocAcqToModulaStylist";
	}
}
