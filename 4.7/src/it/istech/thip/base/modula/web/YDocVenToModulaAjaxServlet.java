...
public class YDocVenToModulaAjaxServlet extends BaseServlet{
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YDocVenToModula gestoreEv = (YDocVenToModula)YDocVenToModula.elementWithKey(YDocVenToModula.class, chiaveRiga, 0);
