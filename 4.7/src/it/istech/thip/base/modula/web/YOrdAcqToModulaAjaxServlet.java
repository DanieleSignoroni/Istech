...
public class YOrdAcqToModulaAjaxServlet extends BaseServlet {
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YOrdAcqToModula gestoreEv = (YOrdAcqToModula)YOrdAcqToModula.elementWithKey(YOrdAcqToModula.class, chiaveRiga, 0);
