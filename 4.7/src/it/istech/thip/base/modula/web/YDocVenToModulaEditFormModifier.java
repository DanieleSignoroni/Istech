...
public class YDocVenToModulaEditFormModifier extends WebFormModifierExtended{
	...
	public void writePostHeadElements(JspWriter out) throws IOException {
		...
		out.println(WebJSTypeList.getImportForJSLibrary("it/istech/thip/base/modula/YDocVenToModulaEdit.js", getServletEnvironment().getRequest()));
