...
public class SiOrdineEsecutivoFormActionAdapter extends OrdineEsecutivoFormActionAdapter {
	...
	protected boolean generaListaModula(String key) throws ServletException, IOException {
		try {
			YMatProToModula.cancellaRigheMaterialiOrdineEsecutivo(key); //svuoto le righe legate al mio ordine di vendita
			YMatProToModula.creaRighePerMaterialiOrdineEsecutivo(key);
		} catch (Exception e) {
