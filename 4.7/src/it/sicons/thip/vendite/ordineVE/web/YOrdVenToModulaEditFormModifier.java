...
public class YOrdVenToModulaEditFormModifier extends WebFormModifierExtended{
	...
	public void writePostHeadElements(JspWriter out) throws IOException {
		...
		out.println(WebJSTypeList.getImportForJSLibrary("it/istech/thip/base/modula/YOrdVenToModulaEdit.js", getServletEnvironment().getRequest()));
