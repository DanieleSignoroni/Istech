...
import com.thera.thermfw.web.ajax.*;
import com.thera.thermfw.web.servlet.*;

import it.istech.thip.base.modula.YOrdVenToModula;

public class YOrdVenToModulaAjaxServlet  extends BaseServlet {
	...
	protected List processBlurForSave(XMLElement xmlReq, String classAD, ServletEnvironment se) throws IOException {
		...
		try {
			...
			YOrdVenToModula gestoreEv = (YOrdVenToModula)YOrdVenToModula.elementWithKey(YOrdVenToModula.class, chiaveRiga, 0);
