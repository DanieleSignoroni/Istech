 ...
 * @author Wizard 04/03/2024 at 16:55:46
 */
/*
 * Revisions:
...
public class YDocProToModulaTM extends TableManager {
  ...
  private void init() throws SQLException {
    configure(QTA_ORIGINALE + ", " + QTA_EVASA + ", " + QTA_RESIDUA + ", " + GIACENZA
         + ", " + QTA_DA_EVADERE + ", " + R_RIGA_DOC + ", " + R_DET_RIGA_DOC + ", " + R_ANNO_DOC_PRO
         + ", " + R_NUMERO_DOC_PRO + ", " + ID_AZIENDA + ", " + R_ARTICOLO + ", " + STATO
