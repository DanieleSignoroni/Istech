 ...
 * @author Wizard 27/02/2024 at 15:03:09
 */
/*
 * Revisions:
...
public class YOrdAcqToModulaTM extends TableManager {
  ...
  private void init() throws SQLException {
    configure(R_RIGA_ORD + ", " + R_DET_RIGA_ORD + ", " + QTA_ORIGINALE + ", " + QTA_EVASA
         + ", " + QTA_RESIDUA + ", " + GIACENZA + ", " + QTA_DA_EVADERE + ", " + R_ANNO_ORD_ACQ
         + ", " + R_NUMERO_ORD_ACQ + ", " + ID_AZIENDA + ", " + R_ARTICOLO + ", " + STATO
